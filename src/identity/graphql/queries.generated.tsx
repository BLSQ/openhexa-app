...
export type AccountPageQuery = { __typename?: 'Query', me: { __typename?: 'Me', user?: { __typename?: 'User', firstName?: string | null, lastName?: string | null, dateJoined: any, id: string, email: string, displayName: string, avatar: { __typename?: 'Avatar', initials: string, color: string } } | null } };
