...
export function useGetPipelineVersionSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetPipelineVersionQuery, GetPipelineVersionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
