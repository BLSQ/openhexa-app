...
- **Workspaces**: View and manage all workspaces in your organization
- **Members**: View and manage all users in your organization
- **Datasets**: Access all datasets in your organization from one place

### Organization-level roles

OpenHEXA has two organization-level roles that provide different levels of administrative control:

![Organization Roles](../assets/images/admin/roles.png){ width="50%" }

#### 👤 Organization Admin

Organization Admins have comprehensive management capabilities across the entire organization. You can:
...
- Delete the entire organization and all its contents
