...
export type PublicWebappQuery = { __typename?: 'Query', publicWebapp?: { __typename?: 'Webapp', id: string, slug: string, name: string, url: string, type: Types.WebappType, isPublic: boolean } | null };
