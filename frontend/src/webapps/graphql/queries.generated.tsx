...
export type WebappFilesQuery = { __typename?: 'Query', webapp?: { __typename?: 'Webapp', id: string, files?: Array<{ __typename?: 'FileNode', id: string, name: string, path: string, type: Types.FileType, content?: string | null, parentId?: string | null, autoSelect: boolean, language?: string | null, lineCount?: number | null, size?: number | null }> | null } | null };
