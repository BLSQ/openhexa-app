...
export type WebappForm_WebappFragment = { __typename?: 'Webapp', id: string, slug: string, name: string, description?: string | null, url: string, type: Types.WebappType, icon?: string | null, isPublic: boolean, permissions: { __typename?: 'WebappPermissions', update: boolean, delete: boolean } };
