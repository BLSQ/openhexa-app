...
export type WebappForm_WebappFragment = { __typename?: 'Webapp', id: string, slug: string, name: string, description?: string | null, url: string, type: Types.WebappType, icon?: string | null, isPublic: boolean, subdomain?: string | null, subdomainUrl?: string | null, source: { __typename?: 'GitSource', publishedVersion?: string | null } | { __typename?: 'IframeSource' } | { __typename?: 'SupersetSource', dashboardId: string, instance: { __typename?: 'SupersetInstance', id: string, name: string, url: string } }, permissions: { __typename?: 'WebappPermissions', update: boolean, delete: boolean } };
