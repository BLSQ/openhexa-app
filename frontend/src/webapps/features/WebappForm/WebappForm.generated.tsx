...
export type WebappForm_WebappFragment = { __typename?: 'Webapp', id: string, slug: string, name: string, description?: string | null, url?: string | null, type: Types.WebappType, icon?: string | null, content?: string | null, permissions: { __typename?: 'WebappPermissions', update: boolean, delete: boolean } };
