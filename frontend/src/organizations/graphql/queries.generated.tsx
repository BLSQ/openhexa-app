...
export type Organization_OrganizationFragment = { __typename?: 'Organization', id: string, name: string, shortName?: string | null, logo?: string | null, assistantEnabled: boolean, assistantModel?: string | null, workspaces: { __typename?: 'WorkspacePage', totalItems: number }, permissions: { __typename?: 'OrganizationPermissions', createWorkspace: boolean, archiveWorkspace: boolean, manageMembers: boolean, manageOwners: boolean, update: boolean, delete: boolean }, members: { __typename?: 'OrganizationMembershipPage', totalItems: number }, externalCollaborators: { __typename?: 'ExternalCollaboratorPage', totalItems: number }, usage: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number, assistantUsage: { __typename?: 'AssistantUsage', inputTokens: number, outputTokens: number, cost: number } }, subscription?: { __typename?: 'Subscription', subscriptionId: string, planCode: string, startDate: any, endDate: any, limits: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number } } | null };
...
export type OrganizationQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, name: string, shortName?: string | null, logo?: string | null, assistantEnabled: boolean, assistantModel?: string | null, workspaces: { __typename?: 'WorkspacePage', totalItems: number }, permissions: { __typename?: 'OrganizationPermissions', createWorkspace: boolean, archiveWorkspace: boolean, manageMembers: boolean, manageOwners: boolean, update: boolean, delete: boolean }, members: { __typename?: 'OrganizationMembershipPage', totalItems: number }, externalCollaborators: { __typename?: 'ExternalCollaboratorPage', totalItems: number }, usage: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number, assistantUsage: { __typename?: 'AssistantUsage', inputTokens: number, outputTokens: number, cost: number } }, subscription?: { __typename?: 'Subscription', subscriptionId: string, planCode: string, startDate: any, endDate: any, limits: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number } } | null } | null };
...
export type OrganizationDatasetsQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, name: string, shortName?: string | null, logo?: string | null, assistantEnabled: boolean, assistantModel?: string | null, datasetLinks: { __typename?: 'DatasetLinkPage', totalItems: number, pageNumber: number, totalPages: number, items: Array<{ __typename?: 'DatasetLink', id: string, workspace: { __typename?: 'Workspace', slug: string, name: string }, dataset: { __typename?: 'Dataset', id: string, slug: string, name: string, description?: string | null, updatedAt: any, sharedWithOrganization: boolean, workspace?: { __typename?: 'Workspace', slug: string, name: string } | null, links: { __typename?: 'DatasetLinkPage', items: Array<{ __typename?: 'DatasetLink', workspace: { __typename?: 'Workspace', slug: string, name: string } }> } } }> }, workspaces: { __typename?: 'WorkspacePage', totalItems: number }, permissions: { __typename?: 'OrganizationPermissions', createWorkspace: boolean, archiveWorkspace: boolean, manageMembers: boolean, manageOwners: boolean, update: boolean, delete: boolean }, members: { __typename?: 'OrganizationMembershipPage', totalItems: number }, externalCollaborators: { __typename?: 'ExternalCollaboratorPage', totalItems: number }, usage: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number, assistantUsage: { __typename?: 'AssistantUsage', inputTokens: number, outputTokens: number, cost: number } }, subscription?: { __typename?: 'Subscription', subscriptionId: string, planCode: string, startDate: any, endDate: any, limits: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number } } | null } | null };
...
export type OrganizationWorkspacesQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, name: string, shortName?: string | null, logo?: string | null, assistantEnabled: boolean, assistantModel?: string | null, workspaces: { __typename?: 'WorkspacePage', totalItems: number }, permissions: { __typename?: 'OrganizationPermissions', createWorkspace: boolean, archiveWorkspace: boolean, manageMembers: boolean, manageOwners: boolean, update: boolean, delete: boolean }, members: { __typename?: 'OrganizationMembershipPage', totalItems: number }, externalCollaborators: { __typename?: 'ExternalCollaboratorPage', totalItems: number }, usage: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number, assistantUsage: { __typename?: 'AssistantUsage', inputTokens: number, outputTokens: number, cost: number } }, subscription?: { __typename?: 'Subscription', subscriptionId: string, planCode: string, startDate: any, endDate: any, limits: { __typename?: 'ResourceCounts', users: number, workspaces: number, pipelineRuns: number } } | null } | null, workspaces: { __typename?: 'WorkspacePage', totalItems: number, pageNumber: number, totalPages: number, items: Array<{ __typename?: 'Workspace', slug: string, name: string, createdAt: any, updatedAt?: any | null, countries: Array<{ __typename?: 'Country', code: string }>, createdBy: { __typename?: 'User', displayName: string, avatar: { __typename?: 'Avatar', initials: string, color: string } }, members: { __typename?: 'WorkspaceMembershipPage', totalItems: number }, permissions: { __typename?: 'WorkspacePermissions', manageMembers: boolean, delete: boolean } }> } };
...
export const OrganizationWithWorkspacesDocument = gql`
...
/**
 * __useOrganizationWithWorkspacesQuery__
 *
 * To run a query within a React component, call `useOrganizationWithWorkspacesQuery` and pass it any options that fit your needs.
 * When your component renders, `useOrganizationWithWorkspacesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOrganizationWithWorkspacesQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useOrganizationWithWorkspacesQuery(baseOptions: Apollo.QueryHookOptions<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables> & ({ variables: OrganizationWithWorkspacesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables>(OrganizationWithWorkspacesDocument, options);
      }
export function useOrganizationWithWorkspacesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables>(OrganizationWithWorkspacesDocument, options);
        }
export function useOrganizationWithWorkspacesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<OrganizationWithWorkspacesQuery, OrganizationWithWorkspacesQueryVariables>(OrganizationWithWorkspacesDocument, options);
        }
export type OrganizationWithWorkspacesQueryHookResult = ReturnType<typeof useOrganizationWithWorkspacesQuery>;
export type OrganizationWithWorkspacesLazyQueryHookResult = ReturnType<typeof useOrganizationWithWorkspacesLazyQuery>;
