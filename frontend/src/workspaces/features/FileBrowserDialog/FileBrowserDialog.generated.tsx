...
export type FileBrowserDialogQuery = { __typename?: 'Query', searchResults?: { __typename?: 'BucketObjectResultPage', totalItems: number, totalPages: number, pageNumber: number, items: Array<{ __typename?: 'BucketObjectResult', score: number, file: { __typename?: 'BucketObject', name: string, key: string, path: string, type: Types.BucketObjectType, updatedAt?: any | null, size?: any | null } }> }, workspace?: { __typename?: 'Workspace', slug: string, bucket: { __typename?: 'Bucket', objects: { __typename?: 'BucketObjectPage', pageNumber: number, hasNextPage: boolean, hasPreviousPage: boolean, items: Array<{ __typename?: 'BucketObject', key: string, name: string, path: string, size?: any | null, updatedAt?: any | null, type: Types.BucketObjectType }> } } } | null };
