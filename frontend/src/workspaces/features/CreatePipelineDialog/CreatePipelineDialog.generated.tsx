...
export type CreatePipelineDialog_WorkspaceFragment = { __typename?: 'Workspace', slug: string, organization?: { __typename?: 'Organization', id: string, aiBudgetLimitReached: boolean, aiSettings?: { __typename?: 'AiSettings', enabled?: boolean | null } | null } | null };
