...
>>>>>>> dd850cfea (pipeline functional type implementation)
...
=======
    query WorkspacePipelinesPage($workspaceSlug: String!, $search: String, $functionalType: PipelineFunctionalType, $page: Int, $perPage: Int) {
>>>>>>> dd850cfea (pipeline functional type implementation)
