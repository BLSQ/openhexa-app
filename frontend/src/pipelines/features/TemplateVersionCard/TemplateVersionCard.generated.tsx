...
export type TemplateVersionCard_VersionFragment = { __typename?: 'PipelineTemplateVersion', id: string, versionNumber: number, name?: string | null, changelog?: string | null, documentation?: string | null, createdAt: any, isLatestVersion: boolean, user?: { __typename?: 'User', displayName: string } | null, permissions: { __typename?: 'PipelineTemplateVersionPermissions', update: boolean, delete: boolean }, template: { __typename?: 'PipelineTemplate', id: string, code: string } };
