...
class BaseAgentRunTest(AgentTestCase):
    ...
    def test_run_saves_user_message(self):
        ...
        self.assertEqual(user_messages.first().content, [{"type": "text", "content": "What can you do?"}])
    ...
    def test_run_saves_assistant_message(self):
        ...
        self.assertEqual(assistant_messages.first().content, [{"type": "text", "content": "Hello!"}])
