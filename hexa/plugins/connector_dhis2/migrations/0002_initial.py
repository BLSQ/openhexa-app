...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='instance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='connector_dhis2.instance'),
        ),
        migrations.AddField(
            model_name='indicatortype',
            name='owner',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='connector_dhis2.indicatortype'),
        ),
        migrations.AddField(
            model_name='indicator',
            name='instance',
