...
def get_api_token(iaso_account: models.Account):
...
def get_forms_json(iaso_account: models.Account):
...
def get_orgunittypes_json(iaso_account: models.Account, api_token: str):
    headers = {"Authorization": "Bearer %s" % api_token}
...
def get_orgunits_level12(iaso_account: models.Account):
    api_token = get_api_token(iaso_account)
