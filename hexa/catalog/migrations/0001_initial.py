    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_type', models.CharField(choices=[('DATASOURCE', 'Datasource'), ('CONTENT ', 'Content')], max_length=100)),
                ...
                ('text_search_config', hexa.common.models.PostgresTextSearchConfigField(choices=[('simple', 'simple'), ('french', 'french'), ('english', 'english')], default='simple', max_length=100)),
